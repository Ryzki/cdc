              ...
              <div class="row">
                  <div class="col-md-8 col-md-push-2">
                      <div class="border-1px p-30 mb-0">
                          <h3 class="text-theme-colored mt-0 pt-5 text-center">Question 17 of 18</h3>
                          <hr>
                              ...
                              <div class="row">
                                  ...
                                  <table class="table">
                                    ...
                                    <tr id="group2" class="text-center" style="border-bottom:dashed 1px gray;">
                                        ...
                                        <td>
                                            <input name="group2" type="radio" id="radio_39" value="4" class="with-gap radio-col-indigo" />
                                        </td>
                                        <td>
                                            <input name="group2" type="radio" id="radio_40" value="5" class="with-gap radio-col-blue" />
                                        </td>
                                        <td></td>
