        ...
        ?>
            <div class="col-lg-6">
                <div class="copyright text-center  text-lg-left  text-muted">
                    &copy; <?= $year['year'] ?> <a href="#" class="font-weight-bold ml-1"><?= $ft->footer ?></a>
                </div>
            </div>
        <?php
        }
...
<script src="<?= base_url('assets_backend') ?>/vendor/sweetalert2/dist/sweetalert2.min.js"></script>
<!-- <script src="<?= base_url('assets_backend') ?>/vendor/quill/dist/quill.min.js"></script> -->
<!-- Argon JS -->
