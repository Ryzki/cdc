        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-3 text-center">
                    ...
                    <img src="<?= base_url('assets') ?>/images/<?= $image['image'] ?>" alt="" class="rounded img-fluid">
                ...
                <div class="col-sm-9">
                    ...
                    <form action="<?= base_url('backend/company/edit_profile') ?>" method="POST">
                        <div class="row py-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" value="<?= $data_company['nama_pt'] ?>">
                        ...
                        <div class="row py-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="jenis" value="<?= $data_company['jenis_pt'] ?>">
                        ...
                        <div class="row py-3 align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="email" value="<?= $data_company['email_pt'] ?>">
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-sm-10 align-items-center">
                                <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control"><?= $data_company['deskripsi'] ?></textarea>
