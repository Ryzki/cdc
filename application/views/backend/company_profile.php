                    ...
                    <div class="col-sm-9">
                        ...
                        <form action="<?= base_url('backend/company/edit_profile') ?>" method="POST">
                            <div class="row py-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" value="<?= $dt->nama_pt ?>">
                            ...
                            <div class="row py-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jenis" value="<?= $dt->jenis_pt ?>">
                            ...
                            <div class="row py-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="email" value="<?= $dt->email_pt ?>">
