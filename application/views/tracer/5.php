              ...
              <div class="row">
                  <div class="col-md-8 col-md-push-2">
                      <div class="border-1px p-30 mb-0">
                          <h3 class="text-theme-colored mt-0 pt-5 text-center">Question 5</h3>
                          <hr>
                              ...
                              <div class="row">
                                  <div class="col-sm-12">
                                      <div class="form-group pl-20">
                                          ...
                                          <label><input id="input1" name="f6" type="number" style="width: 54px;" required> perusahaan/instansi/institusi
                                          </label>
                                      </div>
                                  </div>
                              </div>
