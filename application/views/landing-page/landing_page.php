                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4 pl-0 pl-sm-15">
                          <div class="event-details p-15 mt-20">
                            ...
                            <p><?= (strlen($v->deskripsi) > 207) ? substr($v->deskripsi, 0, 207) : $v->deskripsi  ?></p>
                            <a href="<?= base_url('landing/job_detil?seq=') . $v->id ?>" class="btn btn-flat btn-dark btn-theme-colored btn-sm">Details <i class="fa fa-angle-double-right"></i></a>
                          </div>
                        </div>
                        <div class="col-sm-4">
                      ...
                      <div class="event media mt-0 no-bg no-border">
                        ...
                        <div class="media-body">
                          <div class="event-content pull-left flip pl-20 pl-xs-10">
                            ...
                            <span class="mb-5 font-12 mr-10"><i class="fa fa-clock-o mr-5 text-theme-colored"></i> at <?= substr($a->time_1, 0, 16) ?> - <?= substr($a->time_2, 0, 16) ?></span>
                            <p class="font-12"><i class="fa fa-map-marker mr-5 text-theme-colored"></i> <?= $a->location ?></p>
